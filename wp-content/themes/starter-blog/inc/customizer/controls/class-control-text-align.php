<?php
class StarterBlog_Customizer_Control_Text_Align extends StarterBlog_Customizer_Control_Base {
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-starterblog-text_align">';
		self::before_field();
		?>
		<#

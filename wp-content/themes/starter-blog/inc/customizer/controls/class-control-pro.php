<?php
class StarterBlog_Customizer_Control_Pro extends WP_Customize_Control {
	/**
	 * The control type.
	 *
	 * @access public
	...
	protected function render_content() {
		if ( ! empty( $this->label ) ) : ?>
			<div class="starterblog-pro-teaser">
				...
				<?php endif; ?>
				<a href="<?php echo esc_url( $this->pro_url ); ?>" class="button button-secondary" target="_blank" rel="noopener"><?php echo esc_html_x( 'Learn More', 'Starter Blog Pro upsell', 'starter-blog' ); ?></a>
			</div>
		<?php endif;
	}
}

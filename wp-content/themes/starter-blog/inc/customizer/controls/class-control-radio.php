<?php
class StarterBlog_Customizer_Control_Radio extends StarterBlog_Customizer_Control_Base {
	public $disabled_msg;
	...
	static function field_template() {
		echo '<script type="text/html" id="tmpl-field-starterblog-radio">';
		self::before_field();
		?>
		<#
		...
		<div class="starterblog-field-settings-inner">
			<div class="starterblog-radio-list">

...
class StarterBlog_Builder_Header_Templates {
	...
	function customize() {
		...
		return array(
			...
			array(
				...
				'description'    => '<div class="save-template-form"><input type="text" data-builder-id="header" data-control-id="' . esc_attr( $prefix . 'save' ) . '" class="template-input-name change-by-js"><button class="button button-secondary save-builder-template" type="button">' . esc_html__( 'Save', 'starter-blog' ) . '</button></div>' . $html,
			),
		);
	}
}

StarterBlog_Customize_Layout_Builder()->register_item( 'header', new StarterBlog_Builder_Header_Templates() );

<?php
add_filter( 'starterblog/customize/settings-default', 'starterblog_layout_builder_config_default', 15, 2 );
/**
 ...
 * @return mixed
 */
function starterblog_layout_builder_config_default( $val, $name ) {
	$defaults =
		array(

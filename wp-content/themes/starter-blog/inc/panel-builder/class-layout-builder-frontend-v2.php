 ...
 * @since 1.5.0
 */
class StarterBlog_Layout_Builder_Frontend_V2  extends StarterBlog_Abstract_Layout_Frontend {
	...
	public function render_item( $item_id, $col_id, $row_id, $device ) {
		 ...
		 * @since 1.5.0
		 */
		do_action( 'starterblog/builder/' . $this->id . '/before-item/' . $item_id );
		$object_item = StarterBlog_Customize_Layout_Builder()->get_builder_item( $this->id, $item_id );
		 ...
		 * @since 1.5.0
		 */
		do_action( 'starterblog/builder/' . $this->id . '/after-item/' . $item_id );
...
/**
 * Alias of class StarterBlog_Layout_Builder_Frontend_V2
 *
 * @see StarterBlog_Layout_Builder_Frontend
 *
 * @return StarterBlog_Layout_Builder_Frontend_V2
 */
function StarterBlog_Layout_Builder_Frontend_V2() {
	return StarterBlog_Layout_Builder_Frontend_V2::get_instance();
}

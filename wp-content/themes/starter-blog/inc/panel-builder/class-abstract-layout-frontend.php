 ...
 * @since 1.5.0
 */
abstract class StarterBlog_Abstract_Layout_Frontend {
	...
	public function close_icon( $class = '' ) {
		$menu_sidebar_skin = StarterBlog()->get_setting( 'header_sidebar_text_mode' );
		$close             = '<a class="close is-size-medium ' . $menu_sidebar_skin . esc_attr( $class ) . '" href="#">
        <span class="hamburger hamburger--squeeze is-active">
            <span class="hamburger-box">
              <span class="hamburger-inner"><span class="screen-reader-text">' . __( 'Menu', 'starter-blog' ) . '</span></span>
            </span>
        </span>
        <span class="screen-reader-text">' . __( 'Close', 'starter-blog' ) . '</span>
        </a>';

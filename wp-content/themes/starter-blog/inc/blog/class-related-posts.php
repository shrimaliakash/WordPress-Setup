...
/**
 * Class StarterBlog_Related_Posts
 *
 * @since 1.5.0
 */
class StarterBlog_Related_Posts {
	 ...
	 * Get instance
	 *
	 * @return StarterBlog_Related_Posts
	 */
	...
	function display() {
		...
		if ( $query_posts ) {
			...
			while ( $query_posts->have_posts() ) {
				...
				?>
				<article <?php post_class( 'related-post starterblog-col' ); ?>>
				...
				<div class="related-body">
					...
					StarterBlog_Post_Entry::get_instance()->post_meta( $post, $meta_config, $meta_args );
					if ( $excerpt_length > 0 ) {
						StarterBlog_Post_Entry::get_instance()->post_excerpt( $post, 'custom', $excerpt_length );
					}
					?>
				</div>
				<?php

jQuery(document).ready(function($) {
	...
	jQuery(document).on("selective-refresh-content-rendered", function(e, id) {
		if (
			id === "StarterBlog_Builder_Item_WC_Cart__render" ||
			id === "starterblog_customize_render_header"
		) {
	...
	if (StarterBlog_JS.wc_open_cart) {
	...
	$(document.body).on("click", ".wc-view-switcher .wc-view-mod", function(e) {
		...
		setCookie("starterblog_wc_pl_view_mod", mod, 360);
	});

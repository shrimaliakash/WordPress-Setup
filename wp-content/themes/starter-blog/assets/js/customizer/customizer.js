...
(function($, api) {
	...
	var header_changed = function(partial_id, remove_items) {
		...
		if (
			...
			partial_id === "starterblog_customize_render_header"
		) {
		...
		/**
		 * @since 1.5.0 Add Vanila JS dispatch event.
		 */
	...
	api.bind("preview-ready", function() {
		...
		function setupPreviewNamePosition() {
			$(".starterblog-grid .has_menu.builder-item-focus").each(function() {
				var parentPos = $(this)
					.closest(".starterblog-grid")
					.offset();
	...
	var skips_to_add_shortcut = {
		starterblog_customize_render_header: 1,
		starterblog_customize_render_footer: 1
	};
